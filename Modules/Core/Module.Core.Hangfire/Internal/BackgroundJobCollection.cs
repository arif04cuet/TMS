...
namespace Module.Core.Hangfire.Internal
{
    public class BackgroundJobCollection
    {
        ...
        {
            var jobDescriptor = _jobDescriptorsByArgsType.TryGetValue(argsType, out var obj) ? obj : default;
        ...
        {
            var jobDescriptor = _jobDescriptorsByName.TryGetValue(name, out var obj) ? obj : default;
